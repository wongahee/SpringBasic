...
import gahee.spring.beans.HelloSpring5Bean03Eng;
import gahee.spring.beans.HelloSpring5Bean03Jpn;
import gahee.spring.beans.HelloSpring5Bean03Kor;
...
public class HelloSpring5App03 {
	...
	public static void main(String[] args) {
	    ...
	    // 또한, 객체간의 응집도(tightly coupled)를 피할 수 있고
	    // 객체간의 의존성을 낮출수도 있음
