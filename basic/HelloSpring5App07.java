...
public class HelloSpring5App07 {
	public static void main(String[] args) {
		...
		// DI 방법은 생성자(<construtor-arg>)나 setter(<property>) 중
		// 하나를 선택함
		...
		// @Component : 일반적인 클래스 객체에 사용 (빈 정의시 사용)(*중요*)
		// @Service : 주로 서비스 객체에 사용 (빈 정의시 사용)(*중요*)
		// @Repository : 주로 DAO 객체에 사용 (빈 정의시 사용)(*중요*)
		// @Controller : 주로 MVC 객체에 사용 (*중요*)

		ApplicationContext ctx = new FileSystemXmlApplicationContext("src/bean07.xml");
